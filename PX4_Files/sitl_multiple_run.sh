...
function spawn_model() {
	...
	SUPPORTED_MODELS=("iris" "plane" "standard_vtol" "rover" "r1_rover" "typhoon_h480" "iris_depth_camera")
	...
	set -- ${@} --base_link_name base_link_${N}
	set -- ${@} --camera_plugin_name camera_controller_${N}
	set -- ${@} --camera_name camera_${N}
	set -- ${@} --camera_link_name camera_link_${N}
	set -- ${@} --generate_ros_models True
